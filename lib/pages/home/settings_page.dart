                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text(
                            Get.find<UserController>().user.interests.length.toString(),
                            style: (TextStyle(
                              fontSize: 16,
                              color: Colors.grey,
                            )),
      ...
      builder: (BuildContext context) =>
          CupertinoActionSheet(
              ...
              actions: [
                ...
                CupertinoActionSheetAction(
                  child: const Text('Until Morning',
                      style: TextStyle(fontSize: 16)),
                  onPressed: () {
                    Navigator.pop(context);
                  },
                        ...
                        children: [
                          Stack(
                            children: [
                              ...
                              Center(child: Text(
                                "Account", style: TextStyle(fontSize: 21),)),
                            ],
                          ),
                        ...
                        children: [
                          Stack(
                            children: [
                              ...
                              Center(child: Text(
                                "NOTIFICATION SETTINGS", style: TextStyle(fontSize: 16),)),
                            ],
                          ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      CupertinoSwitch(
                                        ...
                                        onChanged: (value) {
                                          if(value == true){
                                            FirebaseMessaging.instance.subscribeToTopic(roomtopic);
                                          }else{
                                            FirebaseMessaging.instance.unsubscribeFromTopic(roomtopic);
                                          }
                                        },
                                      )
                                    ],
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      CupertinoSwitch(
                                        ...
                                        onChanged: (value) {
                                          if(value == true){
                                            FirebaseMessaging.instance.subscribeToTopic(trendingtopic);
                                          }else{
                                            FirebaseMessaging.instance.unsubscribeFromTopic(trendingtopic);
                                          }
                                        },
                                      )
                                    ],
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      CupertinoSwitch(
                                        ...
                                        onChanged: (value) {
                                          if(value == true){
                                            FirebaseMessaging.instance.subscribeToTopic(otherstopic);
                                          }else{
                                            FirebaseMessaging.instance.unsubscribeFromTopic(otherstopic);
                                          }
                                        },
                                      )
                                    ],
